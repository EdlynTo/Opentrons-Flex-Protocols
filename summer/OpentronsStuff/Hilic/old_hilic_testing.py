...
metadata = {
    "protocolName": "OLD TEST SP3 HILIC protocol- NEW 2026",
    "author": "Nico / Calvin",
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    formic_acid = protocol.define_liquid("Formic Acid", "10% Formic acid", "#42f5c2")
    ...
    if add_formic_acid:
        ...
        #setup formic acid to multiplex
            ...
            for i in range(0, math.ceil(num_samples / 8)):
                ...
                right_pipette.dispense(10, final_tube_rack.wells()[i].bottom(0.5), 0.1)
                remove_tip(right_pipette, protocol.params.dry_run)
